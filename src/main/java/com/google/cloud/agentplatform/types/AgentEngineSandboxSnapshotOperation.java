...
public abstract class AgentEngineSandboxSnapshotOperation extends JsonSerializable {
  ...
  public abstract Optional<SandboxEnvironmentSnapshot> response();

  /** Instantiates a builder for AgentEngineSandboxSnapshotOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_AgentEngineSandboxSnapshotOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for AgentEngineSandboxSnapshotOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `AgentEngineSandboxSnapshotOperation.builder()` for
     * instantiation.
     */
    @JsonCreator
     ...
     * Setter for response.
     *
     * <p>response: The Agent Engine Sandbox Snapshot.
     */
    @JsonProperty("response")
    public abstract Builder response(SandboxEnvironmentSnapshot response);
     ...
     */
    @CanIgnoreReturnValue
    public Builder response(SandboxEnvironmentSnapshot.Builder responseBuilder) {
      return response(responseBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Optional<SandboxEnvironmentSnapshot> response();

    @ExcludeFromGeneratedCoverageReport
    abstract Builder response(Optional<SandboxEnvironmentSnapshot> response);
    ...
    public abstract AgentEngineSandboxSnapshotOperation build();
  }

  /** Deserializes a JSON string to a AgentEngineSandboxSnapshotOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static AgentEngineSandboxSnapshotOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, AgentEngineSandboxSnapshotOperation.class);
  }
}
