...
@AutoValue
@JsonDeserialize(builder = ListMemoryRevisionsResponse.Builder.class)
public abstract class ListMemoryRevisionsResponse extends JsonSerializable {
  ...
  /** Instantiates a builder for ListMemoryRevisionsResponse. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListMemoryRevisionsResponse.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListMemoryRevisionsResponse. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `ListMemoryRevisionsResponse.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract ListMemoryRevisionsResponse build();
  }

  /** Deserializes a JSON string to a ListMemoryRevisionsResponse object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListMemoryRevisionsResponse fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListMemoryRevisionsResponse.class);
  }
}
