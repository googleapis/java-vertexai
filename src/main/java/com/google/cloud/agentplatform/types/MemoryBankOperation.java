...
@AutoValue
@JsonDeserialize(builder = MemoryBankOperation.Builder.class)
public abstract class MemoryBankOperation extends JsonSerializable {
  /**
  ...
  public abstract Optional<MemoryBank> response();

  /** Instantiates a builder for MemoryBankOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_MemoryBankOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for MemoryBankOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `MemoryBankOperation.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for response.
     *
     * <p>response: The created Memory Bank.
     */
    @JsonProperty("response")
    public abstract Builder response(MemoryBank response);
     ...
     */
    @CanIgnoreReturnValue
    public Builder response(MemoryBank.Builder responseBuilder) {
      return response(responseBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Optional<MemoryBank> response();

    @ExcludeFromGeneratedCoverageReport
    abstract Builder response(Optional<MemoryBank> response);
    ...
    public abstract MemoryBankOperation build();
  }

  /** Deserializes a JSON string to a MemoryBankOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static MemoryBankOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, MemoryBankOperation.class);
  }
}
