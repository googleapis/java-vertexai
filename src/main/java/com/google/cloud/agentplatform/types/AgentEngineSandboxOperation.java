...
@AutoValue
@JsonDeserialize(builder = AgentEngineSandboxOperation.Builder.class)
public abstract class AgentEngineSandboxOperation extends JsonSerializable {
  /**
  ...
  public abstract Optional<SandboxEnvironment> response();

  /** Instantiates a builder for AgentEngineSandboxOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_AgentEngineSandboxOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for AgentEngineSandboxOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `AgentEngineSandboxOperation.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for response.
     *
     * <p>response: The Agent Engine Sandbox.
     */
    @JsonProperty("response")
    public abstract Builder response(SandboxEnvironment response);
     ...
     */
    @CanIgnoreReturnValue
    public Builder response(SandboxEnvironment.Builder responseBuilder) {
      return response(responseBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Optional<SandboxEnvironment> response();

    @ExcludeFromGeneratedCoverageReport
    abstract Builder response(Optional<SandboxEnvironment> response);
    ...
    public abstract AgentEngineSandboxOperation build();
  }
