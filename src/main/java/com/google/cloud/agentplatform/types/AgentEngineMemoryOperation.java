...
@AutoValue
@JsonDeserialize(builder = AgentEngineMemoryOperation.Builder.class)
public abstract class AgentEngineMemoryOperation extends JsonSerializable {
  /**
  ...
  public abstract Optional<Memory> response();

  /** Instantiates a builder for AgentEngineMemoryOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_AgentEngineMemoryOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for AgentEngineMemoryOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `AgentEngineMemoryOperation.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for response.
     *
     * <p>response: The Agent Engine Memory.
     */
    @JsonProperty("response")
    public abstract Builder response(Memory response);
     ...
     */
    @CanIgnoreReturnValue
    public Builder response(Memory.Builder responseBuilder) {
      return response(responseBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Builder response(Optional<Memory> response);
    ...
    public abstract AgentEngineMemoryOperation build();
  }

  /** Deserializes a JSON string to a AgentEngineMemoryOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static AgentEngineMemoryOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, AgentEngineMemoryOperation.class);
  }
}
