...
public abstract class ReasoningEngineSpecSourceCodeSpecPythonSpec extends JsonSerializable {
  ...
  public abstract static class Builder {
     ...
     * relative to the root. This field should not be set if the source is `agent_config_source`.
     */
    @JsonProperty("entrypointModule")
     ...
     * to use as the application If not specified, defaults to "root_agent". This field should not
  ...
  public static ReasoningEngineSpecSourceCodeSpecPythonSpec fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, ReasoningEngineSpecSourceCodeSpecPythonSpec.class);
  }
}
