...
public abstract class ReasoningEngineSpec extends JsonSerializable {
  ...
  public abstract Optional<Map<String, Object>> agentCard();
  ...
  public abstract static class Builder {
    ...
    /**
     * Setter for agentCard.
     *
     * <p>agentCard: Optional. The A2A Agent Card for the agent (if available). It follows the
     * specification at
     * https://a2a-protocol.org/latest/specification/#5-agent-discovery-the-agent-card.
     */
    @JsonProperty("agentCard")
    ...
    /** Clears the value of agentCard field. */
    @ExcludeFromGeneratedCoverageReport
    @CanIgnoreReturnValue
    public Builder clearAgentCard() {
      return agentCard(Optional.empty());
    }
  ...
  public static ReasoningEngineSpec fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, ReasoningEngineSpec.class);
  }
}
