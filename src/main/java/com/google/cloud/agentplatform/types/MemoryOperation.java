...
@AutoValue
@JsonDeserialize(builder = MemoryOperation.Builder.class)
public abstract class MemoryOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for MemoryOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_MemoryOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for MemoryOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `MemoryOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Optional<Memory> response();
    ...
    public abstract MemoryOperation build();
  }

  /** Deserializes a JSON string to a MemoryOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static MemoryOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, MemoryOperation.class);
  }
}
