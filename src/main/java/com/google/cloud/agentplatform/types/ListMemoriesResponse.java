...
@AutoValue
@JsonDeserialize(builder = ListMemoriesResponse.Builder.class)
public abstract class ListMemoriesResponse extends JsonSerializable {
  ...
  /** Instantiates a builder for ListMemoriesResponse. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListMemoriesResponse.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListMemoriesResponse. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `ListMemoriesResponse.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract ListMemoriesResponse build();
  }

  /** Deserializes a JSON string to a ListMemoriesResponse object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListMemoriesResponse fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListMemoriesResponse.class);
  }
}
