...
@AutoValue
@JsonDeserialize(builder = PurgeMemoriesConfig.Builder.class)
public abstract class PurgeMemoriesConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for PurgeMemoriesConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_PurgeMemoriesConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for PurgeMemoriesConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `PurgeMemoriesConfig.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract PurgeMemoriesConfig build();
  }

  /** Deserializes a JSON string to a PurgeMemoriesConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static PurgeMemoriesConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, PurgeMemoriesConfig.class);
  }
}
