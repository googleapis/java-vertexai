...
@AutoValue
@InternalApi
@JsonDeserialize(builder = GetAgentEngineSandboxSnapshotOperationParameters.Builder.class)
public abstract class GetAgentEngineSandboxSnapshotOperationParameters extends JsonSerializable {
  ...
  /** Instantiates a builder for GetAgentEngineSandboxSnapshotOperationParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_GetAgentEngineSandboxSnapshotOperationParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for GetAgentEngineSandboxSnapshotOperationParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `GetAgentEngineSandboxSnapshotOperationParameters.builder()`
     * for instantiation.
     */
    @JsonCreator
    ...
    public abstract GetAgentEngineSandboxSnapshotOperationParameters build();
  }

  /** Deserializes a JSON string to a GetAgentEngineSandboxSnapshotOperationParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static GetAgentEngineSandboxSnapshotOperationParameters fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(
        jsonString, GetAgentEngineSandboxSnapshotOperationParameters.class);
  }
}
