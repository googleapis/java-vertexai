...
@AutoValue
@JsonDeserialize(builder = DeleteSandboxEnvironmentSnapshotOperation.Builder.class)
public abstract class DeleteSandboxEnvironmentSnapshotOperation extends JsonSerializable {
  /**
  ...
  public static Builder builder() {
    return new AutoValue_DeleteSandboxEnvironmentSnapshotOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeleteSandboxEnvironmentSnapshotOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `DeleteSandboxEnvironmentSnapshotOperation.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract DeleteSandboxEnvironmentSnapshotOperation build();
  }

  /** Deserializes a JSON string to a DeleteSandboxEnvironmentSnapshotOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeleteSandboxEnvironmentSnapshotOperation fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, DeleteSandboxEnvironmentSnapshotOperation.class);
  }
}
