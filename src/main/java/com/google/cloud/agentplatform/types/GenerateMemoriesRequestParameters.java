...
@AutoValue
@InternalApi
@JsonDeserialize(builder = GenerateMemoriesRequestParameters.Builder.class)
public abstract class GenerateMemoriesRequestParameters extends JsonSerializable {
  ...
  /** */
  @JsonProperty("config")
  public abstract Optional<GenerateMemoriesConfig> config();

  /** Instantiates a builder for GenerateMemoriesRequestParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_GenerateMemoriesRequestParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for GenerateMemoriesRequestParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `GenerateMemoriesRequestParameters.builder()` for
     * instantiation.
     */
    @JsonCreator
     ...
     * Setter for name.
     *
     * <p>name: Name of the Memory Bank to generate memories with.
     */
    @JsonProperty("name")
     ...
     */
    @JsonProperty("config")
    public abstract Builder config(GenerateMemoriesConfig config);
    ...
    public abstract GenerateMemoriesRequestParameters build();
  }

  /** Deserializes a JSON string to a GenerateMemoriesRequestParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static GenerateMemoriesRequestParameters fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, GenerateMemoriesRequestParameters.class);
  }
}
