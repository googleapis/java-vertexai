...
public abstract class AgentEngineConfig extends JsonSerializable {
  ...
  public abstract static class Builder {
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Optional<String> stagingBucket();
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Optional<Object> requirements();
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Optional<String> gcsDirName();
    ...
    @JsonProperty("extraPackages")
    @CanIgnoreReturnValue
    public Builder extraPackages(List<String> extraPackages) {
      if (extraPackages().isPresent()) {
        List<String> list = new java.util.ArrayList<>(extraPackages().get());
        list.addAll(extraPackages);
        return extraPackages(java.util.Optional.of(list));
      }
      return extraPackages(java.util.Optional.of(extraPackages));
    }
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Optional<List<String>> extraPackages();
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Optional<Object> envVars();
     ...
     *
     * <p>imageSpec: The image spec for the Agent Engine.
     */
    @JsonProperty("imageSpec")
     ...
     *
     * <p>agentConfigSource: The agent config source for the Agent Engine.
     */
    @JsonProperty("agentConfigSource")
