...
@AutoValue
@JsonDeserialize(builder = DeleteMemoryOperation.Builder.class)
public abstract class DeleteMemoryOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for DeleteMemoryOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DeleteMemoryOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeleteMemoryOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `DeleteMemoryOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract DeleteMemoryOperation build();
  }

  /** Deserializes a JSON string to a DeleteMemoryOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeleteMemoryOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DeleteMemoryOperation.class);
  }
}
