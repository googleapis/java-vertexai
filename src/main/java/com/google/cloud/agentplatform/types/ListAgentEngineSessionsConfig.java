...
@AutoValue
@JsonDeserialize(builder = ListAgentEngineSessionsConfig.Builder.class)
public abstract class ListAgentEngineSessionsConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for ListAgentEngineSessionsConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListAgentEngineSessionsConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListAgentEngineSessionsConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `ListAgentEngineSessionsConfig.builder()` for instantiation.
     */
    @JsonCreator
    ...
    public abstract ListAgentEngineSessionsConfig build();
  }

  /** Deserializes a JSON string to a ListAgentEngineSessionsConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListAgentEngineSessionsConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListAgentEngineSessionsConfig.class);
  }
}
