...
@AutoValue
@JsonDeserialize(builder = GenerateMemoriesOperation.Builder.class)
public abstract class GenerateMemoriesOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for GenerateMemoriesOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_GenerateMemoriesOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for GenerateMemoriesOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `GenerateMemoriesOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Optional<GenerateMemoriesResponse> response();
    ...
    public abstract GenerateMemoriesOperation build();
  }

  /** Deserializes a JSON string to a GenerateMemoriesOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static GenerateMemoriesOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, GenerateMemoriesOperation.class);
  }
}
