...
@AutoValue
@InternalApi
@JsonDeserialize(builder = RetrieveMemoriesRequestParameters.Builder.class)
public abstract class RetrieveMemoriesRequestParameters extends JsonSerializable {
  ...
  /** */
  @JsonProperty("config")
  public abstract Optional<RetrieveMemoriesConfig> config();

  /** Instantiates a builder for RetrieveMemoriesRequestParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_RetrieveMemoriesRequestParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for RetrieveMemoriesRequestParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `RetrieveMemoriesRequestParameters.builder()` for
     * instantiation.
     */
    @JsonCreator
     ...
     * Setter for name.
     *
     * <p>name: Name of the Memory Bank to retrieve memories from.
     */
    @JsonProperty("name")
     ...
     */
    @JsonProperty("config")
    public abstract Builder config(RetrieveMemoriesConfig config);
    ...
    public abstract RetrieveMemoriesRequestParameters build();
  }

  /** Deserializes a JSON string to a RetrieveMemoriesRequestParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static RetrieveMemoriesRequestParameters fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, RetrieveMemoriesRequestParameters.class);
  }
}
