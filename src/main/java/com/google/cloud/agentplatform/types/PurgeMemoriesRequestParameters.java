...
@AutoValue
@InternalApi
@JsonDeserialize(builder = PurgeMemoriesRequestParameters.Builder.class)
public abstract class PurgeMemoriesRequestParameters extends JsonSerializable {
  ...
  /** */
  @JsonProperty("config")
  public abstract Optional<PurgeMemoriesConfig> config();

  /** Instantiates a builder for PurgeMemoriesRequestParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_PurgeMemoriesRequestParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for PurgeMemoriesRequestParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `PurgeMemoriesRequestParameters.builder()` for instantiation.
     */
    @JsonCreator
     ...
     * Setter for name.
     *
     * <p>name: Name of the Memory Bank to purge memories from.
     */
    @JsonProperty("name")
     ...
     */
    @JsonProperty("config")
    public abstract Builder config(PurgeMemoriesConfig config);
    ...
    public abstract PurgeMemoriesRequestParameters build();
  }

  /** Deserializes a JSON string to a PurgeMemoriesRequestParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static PurgeMemoriesRequestParameters fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, PurgeMemoriesRequestParameters.class);
  }
}
