...
public abstract class ReasoningEngineRevisionGarbageCollectionStrategyKeepNLatest
  ...
  public abstract Optional<Integer> maxRevisions();
  ...
  public abstract static class Builder {
    ...
    /**
     * Setter for maxRevisions.
     *
     * <p>maxRevisions: Required. Specifies the maximum number of Runtime Revisions to keep active.
     * If an update to Reasoning Engine would result in exceeding this number of active Runtime
     * Revisions, a new Runtime Revision will be created, while the oldest Runtime Revision will be
     * automatically deleted, providing it's not configured to serve traffic via `traffic_config`.
     * If the oldest Runtime Revision is configured to serve traffic, the update will fail
     * validation. No changes will be made to the Reasoning Engine, existing Runtime Revisions, and
     * no new Runtime Revision will be created.
     */
    @JsonProperty("maxRevisions")
    public abstract Builder maxRevisions(Integer maxRevisions);

    @ExcludeFromGeneratedCoverageReport
    abstract Builder maxRevisions(Optional<Integer> maxRevisions);

    /** Clears the value of maxRevisions field. */
    @ExcludeFromGeneratedCoverageReport
    @CanIgnoreReturnValue
    public Builder clearMaxRevisions() {
      return maxRevisions(Optional.empty());
    }
