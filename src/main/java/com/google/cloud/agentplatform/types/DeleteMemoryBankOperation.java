...
@AutoValue
@JsonDeserialize(builder = DeleteMemoryBankOperation.Builder.class)
public abstract class DeleteMemoryBankOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for DeleteMemoryBankOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DeleteMemoryBankOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeleteMemoryBankOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `DeleteMemoryBankOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract DeleteMemoryBankOperation build();
  }

  /** Deserializes a JSON string to a DeleteMemoryBankOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeleteMemoryBankOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DeleteMemoryBankOperation.class);
  }
}
