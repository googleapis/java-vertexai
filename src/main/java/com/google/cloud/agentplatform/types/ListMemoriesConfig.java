...
@AutoValue
@JsonDeserialize(builder = ListMemoriesConfig.Builder.class)
public abstract class ListMemoriesConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for ListMemoriesConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListMemoriesConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListMemoriesConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `ListMemoriesConfig.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract ListMemoriesConfig build();
  }

  /** Deserializes a JSON string to a ListMemoriesConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListMemoriesConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListMemoriesConfig.class);
  }
}
