...
@AutoValue
@JsonDeserialize(builder = RetrieveMemoriesConfig.Builder.class)
public abstract class RetrieveMemoriesConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for RetrieveMemoriesConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_RetrieveMemoriesConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for RetrieveMemoriesConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `RetrieveMemoriesConfig.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract RetrieveMemoriesConfig build();
  }

  /** Deserializes a JSON string to a RetrieveMemoriesConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static RetrieveMemoriesConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, RetrieveMemoriesConfig.class);
  }
}
