...
@AutoValue
@JsonDeserialize(builder = ListMemoryRevisionsConfig.Builder.class)
public abstract class ListMemoryRevisionsConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for ListMemoryRevisionsConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListMemoryRevisionsConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListMemoryRevisionsConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `ListMemoryRevisionsConfig.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract ListMemoryRevisionsConfig build();
  }

  /** Deserializes a JSON string to a ListMemoryRevisionsConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListMemoryRevisionsConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListMemoryRevisionsConfig.class);
  }
}
