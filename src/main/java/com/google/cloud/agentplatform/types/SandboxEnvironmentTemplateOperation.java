...
@AutoValue
@JsonDeserialize(builder = SandboxEnvironmentTemplateOperation.Builder.class)
public abstract class SandboxEnvironmentTemplateOperation extends JsonSerializable {
  /**
  ...
  public abstract Optional<SandboxEnvironmentTemplate> response();

  /** Instantiates a builder for SandboxEnvironmentTemplateOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_SandboxEnvironmentTemplateOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for SandboxEnvironmentTemplateOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `SandboxEnvironmentTemplateOperation.builder()` for
     * instantiation.
     */
    @JsonCreator
     ...
     * Setter for response.
     *
     * <p>response: The Agent Engine Sandbox Template.
     */
    @JsonProperty("response")
    public abstract Builder response(SandboxEnvironmentTemplate response);
     ...
     */
    @CanIgnoreReturnValue
    public Builder response(SandboxEnvironmentTemplate.Builder responseBuilder) {
      return response(responseBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Optional<SandboxEnvironmentTemplate> response();

    @ExcludeFromGeneratedCoverageReport
    abstract Builder response(Optional<SandboxEnvironmentTemplate> response);
    ...
    public abstract SandboxEnvironmentTemplateOperation build();
  }

  /** Deserializes a JSON string to a SandboxEnvironmentTemplateOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static SandboxEnvironmentTemplateOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, SandboxEnvironmentTemplateOperation.class);
  }
}
