...
@AutoValue
@JsonDeserialize(builder = UpdateMemoryConfig.Builder.class)
public abstract class UpdateMemoryConfig extends JsonSerializable {
   ...
   * memory resource name. If not provided, Vertex AI will generate a value for this ID. This value
  ...
  /** Instantiates a builder for UpdateMemoryConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_UpdateMemoryConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for UpdateMemoryConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `UpdateMemoryConfig.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for memoryId.
     *
     * <p>memoryId: Optional. The user defined ID to use for memory, which will become the final
     ...
     */
    @JsonProperty("memoryId")
    public abstract Builder memoryId(String memoryId);

    @ExcludeFromGeneratedCoverageReport
    abstract Optional<String> memoryId();

    @ExcludeFromGeneratedCoverageReport
    abstract Builder memoryId(Optional<String> memoryId);

    /** Clears the value of memoryId field. */
    @ExcludeFromGeneratedCoverageReport
    @CanIgnoreReturnValue
    ...
    public abstract UpdateMemoryConfig build();
  }

  /** Deserializes a JSON string to a UpdateMemoryConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static UpdateMemoryConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, UpdateMemoryConfig.class);
  }
}
