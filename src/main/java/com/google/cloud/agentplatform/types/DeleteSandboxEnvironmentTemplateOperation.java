...
@AutoValue
@JsonDeserialize(builder = DeleteSandboxEnvironmentTemplateOperation.Builder.class)
public abstract class DeleteSandboxEnvironmentTemplateOperation extends JsonSerializable {
  /**
  ...
  public static Builder builder() {
    return new AutoValue_DeleteSandboxEnvironmentTemplateOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeleteSandboxEnvironmentTemplateOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `DeleteSandboxEnvironmentTemplateOperation.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract DeleteSandboxEnvironmentTemplateOperation build();
  }

  /** Deserializes a JSON string to a DeleteSandboxEnvironmentTemplateOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeleteSandboxEnvironmentTemplateOperation fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, DeleteSandboxEnvironmentTemplateOperation.class);
  }
}
