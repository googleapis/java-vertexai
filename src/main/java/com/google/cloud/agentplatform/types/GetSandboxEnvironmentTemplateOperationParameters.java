...
@AutoValue
@InternalApi
@JsonDeserialize(builder = GetSandboxEnvironmentTemplateOperationParameters.Builder.class)
public abstract class GetSandboxEnvironmentTemplateOperationParameters extends JsonSerializable {
  ...
  /** Instantiates a builder for GetSandboxEnvironmentTemplateOperationParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_GetSandboxEnvironmentTemplateOperationParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for GetSandboxEnvironmentTemplateOperationParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `GetSandboxEnvironmentTemplateOperationParameters.builder()`
     * for instantiation.
     */
    @JsonCreator
    ...
    public abstract GetSandboxEnvironmentTemplateOperationParameters build();
  }

  /** Deserializes a JSON string to a GetSandboxEnvironmentTemplateOperationParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static GetSandboxEnvironmentTemplateOperationParameters fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(
        jsonString, GetSandboxEnvironmentTemplateOperationParameters.class);
  }
}
