...
@AutoValue
@JsonDeserialize(builder = ListAgentEngineSandboxesConfig.Builder.class)
public abstract class ListAgentEngineSandboxesConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for ListAgentEngineSandboxesConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListAgentEngineSandboxesConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListAgentEngineSandboxesConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `ListAgentEngineSandboxesConfig.builder()` for instantiation.
     */
    @JsonCreator
    ...
    public abstract ListAgentEngineSandboxesConfig build();
  }

  /** Deserializes a JSON string to a ListAgentEngineSandboxesConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListAgentEngineSandboxesConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListAgentEngineSandboxesConfig.class);
  }
}
