...
@AutoValue
@InternalApi
@JsonDeserialize(builder = GetAgentEngineSessionOperationParameters.Builder.class)
public abstract class GetAgentEngineSessionOperationParameters extends JsonSerializable {
  ...
  /** Instantiates a builder for GetAgentEngineSessionOperationParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_GetAgentEngineSessionOperationParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for GetAgentEngineSessionOperationParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `GetAgentEngineSessionOperationParameters.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract GetAgentEngineSessionOperationParameters build();
  }

  /** Deserializes a JSON string to a GetAgentEngineSessionOperationParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static GetAgentEngineSessionOperationParameters fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, GetAgentEngineSessionOperationParameters.class);
  }
}
