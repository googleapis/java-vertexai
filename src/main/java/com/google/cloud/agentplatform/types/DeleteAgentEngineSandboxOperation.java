...
@AutoValue
@JsonDeserialize(builder = DeleteAgentEngineSandboxOperation.Builder.class)
public abstract class DeleteAgentEngineSandboxOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for DeleteAgentEngineSandboxOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DeleteAgentEngineSandboxOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeleteAgentEngineSandboxOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `DeleteAgentEngineSandboxOperation.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract DeleteAgentEngineSandboxOperation build();
  }

  /** Deserializes a JSON string to a DeleteAgentEngineSandboxOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeleteAgentEngineSandboxOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DeleteAgentEngineSandboxOperation.class);
  }
}
