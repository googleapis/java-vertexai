...
@AutoValue
@JsonDeserialize(builder = DeleteAgentEngineSessionOperation.Builder.class)
public abstract class DeleteAgentEngineSessionOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for DeleteAgentEngineSessionOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DeleteAgentEngineSessionOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeleteAgentEngineSessionOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `DeleteAgentEngineSessionOperation.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract DeleteAgentEngineSessionOperation build();
  }

  /** Deserializes a JSON string to a DeleteAgentEngineSessionOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeleteAgentEngineSessionOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DeleteAgentEngineSessionOperation.class);
  }
}
