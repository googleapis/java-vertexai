...
@AutoValue
@JsonDeserialize(builder = RollbackMemoryOperation.Builder.class)
public abstract class RollbackMemoryOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for RollbackMemoryOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_RollbackMemoryOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for RollbackMemoryOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `RollbackMemoryOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract RollbackMemoryOperation build();
  }

  /** Deserializes a JSON string to a RollbackMemoryOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static RollbackMemoryOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, RollbackMemoryOperation.class);
  }
}
