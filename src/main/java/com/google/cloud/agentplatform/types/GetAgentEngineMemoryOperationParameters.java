...
@AutoValue
@InternalApi
@JsonDeserialize(builder = GetAgentEngineMemoryOperationParameters.Builder.class)
public abstract class GetAgentEngineMemoryOperationParameters extends JsonSerializable {
  ...
  /** Instantiates a builder for GetAgentEngineMemoryOperationParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_GetAgentEngineMemoryOperationParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for GetAgentEngineMemoryOperationParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `GetAgentEngineMemoryOperationParameters.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract GetAgentEngineMemoryOperationParameters build();
  }

  /** Deserializes a JSON string to a GetAgentEngineMemoryOperationParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static GetAgentEngineMemoryOperationParameters fromJson(String jsonString) {
    return Common.fromJsonString(jsonString, GetAgentEngineMemoryOperationParameters.class);
  }
}
