...
@AutoValue
@JsonDeserialize(builder = ListSandboxEnvironmentTemplatesConfig.Builder.class)
public abstract class ListSandboxEnvironmentTemplatesConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for ListSandboxEnvironmentTemplatesConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListSandboxEnvironmentTemplatesConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListSandboxEnvironmentTemplatesConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `ListSandboxEnvironmentTemplatesConfig.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract ListSandboxEnvironmentTemplatesConfig build();
  }
