...
@AutoValue
@JsonDeserialize(builder = DeleteAgentEngineMemoryOperation.Builder.class)
public abstract class DeleteAgentEngineMemoryOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for DeleteAgentEngineMemoryOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DeleteAgentEngineMemoryOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeleteAgentEngineMemoryOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `DeleteAgentEngineMemoryOperation.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract DeleteAgentEngineMemoryOperation build();
  }

  /** Deserializes a JSON string to a DeleteAgentEngineMemoryOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeleteAgentEngineMemoryOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DeleteAgentEngineMemoryOperation.class);
  }
}
