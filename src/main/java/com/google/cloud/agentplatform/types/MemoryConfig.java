...
@AutoValue
@JsonDeserialize(builder = MemoryConfig.Builder.class)
public abstract class MemoryConfig extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_MemoryConfig.Builder();
  }
  ...
  public abstract static class Builder {
    /** For internal usage. Please use `MemoryConfig.builder()` for instantiation. */
    @JsonCreator
  ...
  /** Deserializes a JSON string to a MemoryConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static MemoryConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, MemoryConfig.class);
  }
}
