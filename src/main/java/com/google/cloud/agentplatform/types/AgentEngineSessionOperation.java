...
@AutoValue
@JsonDeserialize(builder = AgentEngineSessionOperation.Builder.class)
public abstract class AgentEngineSessionOperation extends JsonSerializable {
  /**
  ...
  public abstract Optional<Session> response();

  /** Instantiates a builder for AgentEngineSessionOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_AgentEngineSessionOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for AgentEngineSessionOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `AgentEngineSessionOperation.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for response.
     *
     * <p>response: The Agent Engine Session.
     */
    @JsonProperty("response")
    public abstract Builder response(Session response);
     ...
     */
    @CanIgnoreReturnValue
    public Builder response(Session.Builder responseBuilder) {
      return response(responseBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Optional<Session> response();

    @ExcludeFromGeneratedCoverageReport
    abstract Builder response(Optional<Session> response);
    ...
    public abstract AgentEngineSessionOperation build();
  }

  /** Deserializes a JSON string to a AgentEngineSessionOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static AgentEngineSessionOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, AgentEngineSessionOperation.class);
  }
}
