...
@AutoValue
@JsonDeserialize(builder = ListAgentEngineConfig.Builder.class)
public abstract class ListAgentEngineConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for ListAgentEngineConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListAgentEngineConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListAgentEngineConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `ListAgentEngineConfig.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract ListAgentEngineConfig build();
  }

  /** Deserializes a JSON string to a ListAgentEngineConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListAgentEngineConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListAgentEngineConfig.class);
  }
}
