...
@AutoValue
@JsonDeserialize(builder = AgentEngineRollbackMemoryOperation.Builder.class)
public abstract class AgentEngineRollbackMemoryOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for AgentEngineRollbackMemoryOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_AgentEngineRollbackMemoryOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for AgentEngineRollbackMemoryOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `AgentEngineRollbackMemoryOperation.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract AgentEngineRollbackMemoryOperation build();
  }

  /** Deserializes a JSON string to a AgentEngineRollbackMemoryOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static AgentEngineRollbackMemoryOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, AgentEngineRollbackMemoryOperation.class);
  }
}
