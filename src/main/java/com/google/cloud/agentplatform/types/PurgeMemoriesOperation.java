...
@AutoValue
@JsonDeserialize(builder = PurgeMemoriesOperation.Builder.class)
public abstract class PurgeMemoriesOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for PurgeMemoriesOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_PurgeMemoriesOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for PurgeMemoriesOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `PurgeMemoriesOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    @ExcludeFromGeneratedCoverageReport
    abstract Optional<PurgeMemoriesResponse> response();
    ...
    public abstract PurgeMemoriesOperation build();
  }

  /** Deserializes a JSON string to a PurgeMemoriesOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static PurgeMemoriesOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, PurgeMemoriesOperation.class);
  }
}
