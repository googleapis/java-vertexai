...
@AutoValue
@JsonDeserialize(builder = AgentEngineOperation.Builder.class)
public abstract class AgentEngineOperation extends JsonSerializable {
  /**
  ...
  public abstract Optional<ReasoningEngine> response();

  /** Instantiates a builder for AgentEngineOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_AgentEngineOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for AgentEngineOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `AgentEngineOperation.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for response.
     *
     * <p>response: The created Agent Engine.
     */
    @JsonProperty("response")
    public abstract Builder response(ReasoningEngine response);
    ...
    public abstract AgentEngineOperation build();
  }

  /** Deserializes a JSON string to a AgentEngineOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static AgentEngineOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, AgentEngineOperation.class);
  }
}
