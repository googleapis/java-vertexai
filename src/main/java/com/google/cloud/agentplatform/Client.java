...
public final class Client implements AutoCloseable {
  ...
  private static final String SDK_VERSION = "0.0.0";
  ...
  static {
    ...
    TRACKING_HEADERS =
        ImmutableMap.of(
            "x-goog-api-client", frameworkLabel,
            "user-agent", frameworkLabel);
  }
  ...
  public static class Builder {
    ...
    public Client build() {
      return new Client(
          apiKey, project, location, credentials, httpOptions, clientOptions, debugConfig);
    }
    ...
    if (this.debugConfig.clientMode().equals("replay")) {
      this.apiClient =
          new ReplayApiClient(
              ...
              // TODO(tangmatthew): Merge with httpOptions arg.
              /* httpOptions= */ Optional.ofNullable(
                  HttpOptions.builder().headers(TRACKING_HEADERS).build()),
