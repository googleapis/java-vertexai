...
@AutoValue
@JsonDeserialize(builder = CreateAgentEngineConfig.Builder.class)
public abstract class CreateAgentEngineConfig extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_CreateAgentEngineConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for CreateAgentEngineConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `CreateAgentEngineConfig.builder()` for instantiation. */
    @JsonCreator
