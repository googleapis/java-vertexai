...
@AutoValue
@JsonDeserialize(builder = AgentEnginePurgeMemoriesOperation.Builder.class)
public abstract class AgentEnginePurgeMemoriesOperation extends JsonSerializable {
  /**
  ...
  public abstract Optional<PurgeMemoriesResponse> response();

  /** Instantiates a builder for AgentEnginePurgeMemoriesOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_AgentEnginePurgeMemoriesOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for AgentEnginePurgeMemoriesOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `AgentEnginePurgeMemoriesOperation.builder()` for
     * instantiation.
     */
    @JsonCreator
     ...
     * Setter for response.
     *
     * <p>response: The response for purging memories.
     */
    @JsonProperty("response")
    public abstract Builder response(PurgeMemoriesResponse response);
     ...
     */
    @CanIgnoreReturnValue
    public Builder response(PurgeMemoriesResponse.Builder responseBuilder) {
      return response(responseBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Builder response(Optional<PurgeMemoriesResponse> response);
    ...
    public abstract AgentEnginePurgeMemoriesOperation build();
  }

  /** Deserializes a JSON string to a AgentEnginePurgeMemoriesOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static AgentEnginePurgeMemoriesOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, AgentEnginePurgeMemoriesOperation.class);
  }
}
