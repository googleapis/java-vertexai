...
public abstract class StructuredMemoryConfig extends JsonSerializable {
  ...
  public abstract Optional<List<StructuredMemoryConfigSchemaConfig>> schemaConfigs();
  ...
  public abstract static class Builder {
     ...
     */
    @JsonProperty("schemaConfigs")
    public abstract Builder schemaConfigs(List<StructuredMemoryConfigSchemaConfig> schemaConfigs);
     ...
     */
    @CanIgnoreReturnValue
    public Builder schemaConfigs(StructuredMemoryConfigSchemaConfig... schemaConfigs) {
     ...
     */
    @CanIgnoreReturnValue
    public Builder schemaConfigs(
        StructuredMemoryConfigSchemaConfig.Builder... schemaConfigsBuilders) {
      return schemaConfigs(
          Arrays.asList(schemaConfigsBuilders).stream()
              .map(StructuredMemoryConfigSchemaConfig.Builder::build)
              .collect(toImmutableList()));
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Builder schemaConfigs(
        Optional<List<StructuredMemoryConfigSchemaConfig>> schemaConfigs);
