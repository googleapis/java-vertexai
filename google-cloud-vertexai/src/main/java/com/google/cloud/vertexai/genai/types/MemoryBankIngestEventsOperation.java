...
@AutoValue
@JsonDeserialize(builder = MemoryBankIngestEventsOperation.Builder.class)
public abstract class MemoryBankIngestEventsOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for MemoryBankIngestEventsOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_MemoryBankIngestEventsOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for MemoryBankIngestEventsOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `MemoryBankIngestEventsOperation.builder()` for instantiation.
     */
    @JsonCreator
    ...
    public abstract MemoryBankIngestEventsOperation build();
  }

  /** Deserializes a JSON string to a MemoryBankIngestEventsOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static MemoryBankIngestEventsOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, MemoryBankIngestEventsOperation.class);
  }
}
