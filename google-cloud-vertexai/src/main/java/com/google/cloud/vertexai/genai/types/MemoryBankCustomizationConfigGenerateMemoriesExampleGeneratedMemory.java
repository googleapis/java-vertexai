...
public abstract class MemoryBankCustomizationConfigGenerateMemoriesExampleGeneratedMemory
  ...
  /**
   * Instantiates a builder for MemoryBankCustomizationConfigGenerateMemoriesExampleGeneratedMemory.
   */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_MemoryBankCustomizationConfigGenerateMemoriesExampleGeneratedMemory
        .Builder();
  }
  ...
  /** Builder for MemoryBankCustomizationConfigGenerateMemoriesExampleGeneratedMemory. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use
     * `MemoryBankCustomizationConfigGenerateMemoriesExampleGeneratedMemory.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract MemoryBankCustomizationConfigGenerateMemoriesExampleGeneratedMemory build();
  }

  /**
   * Deserializes a JSON string to a
   * MemoryBankCustomizationConfigGenerateMemoriesExampleGeneratedMemory object.
   */
  @ExcludeFromGeneratedCoverageReport
