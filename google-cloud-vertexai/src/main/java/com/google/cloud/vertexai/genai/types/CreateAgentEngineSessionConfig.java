...
@AutoValue
@JsonDeserialize(builder = CreateAgentEngineSessionConfig.Builder.class)
public abstract class CreateAgentEngineSessionConfig extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_CreateAgentEngineSessionConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for CreateAgentEngineSessionConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `CreateAgentEngineSessionConfig.builder()` for instantiation.
     */
    @JsonCreator
  ...
  /** Deserializes a JSON string to a CreateAgentEngineSessionConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static CreateAgentEngineSessionConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, CreateAgentEngineSessionConfig.class);
  }
}
