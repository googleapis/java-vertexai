...
public abstract class MemoryBankCustomizationConfigGenerateMemoriesExampleConversationSourceEvent
  ...
  public static Builder builder() {
    return new AutoValue_MemoryBankCustomizationConfigGenerateMemoriesExampleConversationSourceEvent
        .Builder();
  }
  ...
  /** Builder for MemoryBankCustomizationConfigGenerateMemoriesExampleConversationSourceEvent. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use
     * `MemoryBankCustomizationConfigGenerateMemoriesExampleConversationSourceEvent.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract MemoryBankCustomizationConfigGenerateMemoriesExampleConversationSourceEvent
        build();
  }

  /**
   * Deserializes a JSON string to a
   * MemoryBankCustomizationConfigGenerateMemoriesExampleConversationSourceEvent object.
   */
  @ExcludeFromGeneratedCoverageReport
  public static MemoryBankCustomizationConfigGenerateMemoriesExampleConversationSourceEvent
      fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(
        jsonString,
        MemoryBankCustomizationConfigGenerateMemoriesExampleConversationSourceEvent.class);
  }
}
