...
@AutoValue
@JsonDeserialize(builder = AgentEngineMemoryConfig.Builder.class)
public abstract class AgentEngineMemoryConfig extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_AgentEngineMemoryConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for AgentEngineMemoryConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `AgentEngineMemoryConfig.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract AgentEngineMemoryConfig build();
  }
