...
@AutoValue
@JsonDeserialize(builder = ListAgentEngineSessionEventsConfig.Builder.class)
public abstract class ListAgentEngineSessionEventsConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for ListAgentEngineSessionEventsConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListAgentEngineSessionEventsConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListAgentEngineSessionEventsConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `ListAgentEngineSessionEventsConfig.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract ListAgentEngineSessionEventsConfig build();
  }

  /** Deserializes a JSON string to a ListAgentEngineSessionEventsConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListAgentEngineSessionEventsConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListAgentEngineSessionEventsConfig.class);
  }
}
