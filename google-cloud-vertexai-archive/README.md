...
> are **deprecated as of June 24, 2025** and is thus excluded from the
com.google.cloud.agentplatform package.
> Please use the
...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-vertexai" % "1.52.0"
```
